                        ...
                        <div class="col-md-5 ">
                            <form method="POST" action="insert_pelanggan.php">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" name="nik_ktp_faisal" class="form-control" id="nik_ktp_faisal" placeholder="Masukan NIK" required>
                                </div>
                                <div class="mb-3 mt-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="alamat_faisal" class="form-control" id="alamat_faisal" placeholder="Masukan Alamat" required>
                                </div>
                                <div class="mb-3">
